...
Selection = (function() {
  function Selection(doc, emitter) {
    var currentElement, parentDocFragment;
    this.doc = doc;
    ...
    currentElement = this.doc.root.parentNode;
    while ((currentElement != null ? currentElement.nodeType : void 0) !== Node.DOCUMENT_FRAGMENT_NODE && currentElement.nodeType !== Node.DOCUMENT_NODE) {
      currentElement = currentElement.parentNode;
    }
    if ((currentElement != null ? currentElement.nodeType : void 0) === Node.DOCUMENT_FRAGMENT_NODE) {
      parentDocFragment = currentElement;
    }
    this.rootDocHost = this.doc.root;
    this.rootSelectionDoc = document;
    if ((parentDocFragment != null ? parentDocFragment.host : void 0) != null) {
      this.rootDocHost = parentDocFragment.host;
    }
    if ((parentDocFragment != null ? parentDocFragment.getSelection : void 0) != null) {
      this.rootSelectionDoc = parentDocFragment;
    }
    this.update('silent');
  }

  Selection.prototype.checkFocus = function() {
    return document.activeElement === this.doc.root || (document.activeElement === this.rootDocHost);
  };
  ...
  Selection.prototype._getNativeRange = function() {
    var range, selection;
    selection = this.rootSelectionDoc.getSelection();
